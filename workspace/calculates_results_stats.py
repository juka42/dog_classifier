...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        # calculate number of dogs, not dogs and label matches
        ...
        #calculate number of dogs correctly classified as dogs
        if results_dic[key][3] ==1 and results_dic[key][4]==1:
            result_statistics_dic["n_correct_dogs"] += 1
        #calculate number of not dogs correctly classified as non dogs
        if results_dic[key][3] ==0 and results_dic[key][4]==0:
            result_statistics_dic["n_correct_notdogs"] += 1
        #calculate number of dogs with correctly classified breeds
